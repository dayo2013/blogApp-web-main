...
const Post = ({ post }) => {
  ...
  const { config } = usePrepareContractWrite({
    ...
    args: [post.poster, parseEther(tip), post.id],
    account: address,
  });
  ...
  return (
    <div className="max-w-xl mx-auto">
      <div class="group flex flex-col bg-white rounded-xl hover:shadow-md transition">
      ...
      <button
        className="bg-primary inline-flex px-6 py-4 rounded-lg text-white font-medium"
